describe('Register Test',() => {
    it ('Registration fail test',() => {
        cy.fixture('Registration').then(data => {
            ...
            cy.log('Ввод логина')
            cy.get(':nth-child(1) > :nth-child(1) > .form-control--medium > .form-input--text').type(data.login_fail_register)
            cy.log('Ввод email')
            cy.get('.form-input--email').type(data.email_fail_register)
            cy.log('Ввод пароля')
            ...
            cy.log('Ввод фамилии')
            cy.get('[style=""] > :nth-child(1) > .form-control--medium > .form-input--text').type(data.surname_fail_register)
            cy.log('Ввод имени')
